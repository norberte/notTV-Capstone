...
class OldTorrentAssembler {
    ...
    public Torrent makeTorrent(Collection<Node> nodes, List<File> files, String dirname) {
	if(files.size() < 1) 
    ...
    public Torrent makeTorrent(Collection<Node> nodes, File file) {
